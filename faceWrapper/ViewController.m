...
- (void)viewDidLoad
{
    ...
    [FWKeysHelper setFaceAPI:@"7572e26a0b6719c75deda59fa6b70aba"];
    [FWKeysHelper setFaceSecretAPI:@"455f2a94d9af57994972cb6f9acb28a1"];
    
    //Define your Facebook Tokens at https://developers.facebook.com and set them in your face.com account

    [FWKeysHelper setFacebookAppID:@"334317689944137"];
